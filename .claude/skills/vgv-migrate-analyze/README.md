...
# Platform-specific
/vgv-migrate-analyze ios
/vgv-migrate-analyze android

# Focus areas
/vgv-migrate-analyze full screens
/vgv-migrate-analyze ios testing
/vgv-migrate-analyze android cicd

# With Swagger/OpenAPI spec
/vgv-migrate-analyze full --swagger=api/openapi.yaml
```
...
```bash
skills-ref validate ./vgv-migrate-analyze
```
