...
```
/vgv-migrate-analyze [platform] [focus-area] [--swagger=path]
```
...
```bash
/vgv-migrate-analyze full                      # Complete analysis
/vgv-migrate-analyze ios screens               # iOS screens only
/vgv-migrate-analyze full --swagger=api/openapi.yaml  # With API spec
```
